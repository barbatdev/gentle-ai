...
func TestHelpContainsAllCommands(t *testing.T) {
	...
	commands := []string{"install", "uninstall", "sync", "sdd-status", "sdd-continue", "sdd-attempt <acquire [--profile <file>]|settle>", "sdd-verify-validate", "review start", "review capture-result", "review capture-correction-plan", "review capture-refuter", "review capture-validation", "review validate", "review status", "review repair", "review-start", "review-resume", "review-bundle-export", "review-bundle-import", "review-validate", "update", "upgrade", "restore", "version"}

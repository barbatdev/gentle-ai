...
func TestUpdateHint(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    "Windows binary distribution and Scoop are temporarily unavailable until publicly trusted Authenticode signing is enforced. Install/update from source with Go 1.25.12+: go install github.com/gentleman-programming/gentle-ai/v2/cmd/gentle-ai@latest",
		},
		{
